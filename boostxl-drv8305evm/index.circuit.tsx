import { DRV8305NPHPR } from "./imports/DRV8305NPHPR";
import { LKME1601J331MF } from "./imports/LKME1601J331MF";
import { LMR16006XDDCR } from "./imports/LMR16006XDDCR";
import { PM254_2_10_Z_8_5 } from "./imports/PM254_2_10_Z_8_5";
import { PhaseBridge } from "./imports/PhaseBridge";
import { SmaDiode } from "./imports/SmaDiode";
import { SMNR8040_150MT } from "./imports/SMNR8040_150MT";
	...
	return (
		...
		>
			...
			>
				<schematicsection
					name="input-power"
					displayName="DC Input & Bulk Storage"
				/>
			...
			>
				...
				<schematicsection
					name="driver-supplies"
					displayName="Bias & Local Supplies"
				/>
			...
			>
				<schematicsection
					name="boosterpack-io"
					displayName="BoosterPack Headers"
				/>
				<schematicsection
					name="voltage-sense"
					displayName="Voltage Sense & Protection"
				/>
				<schematicsection
					name="current-sense"
					displayName="Current Sense Filters"
				/>
			</schematicsheet>
			<schematicsheet
				name="aux-power"
			...
			>
				...
				<schematicsection
					name="buck-output"
					displayName="3.3 V Output & Feedback"
				/>
			...
			{false && (
				<>
					...
					/>
					<autoroutingphase
						name="ROUTE_VSEN_B_DIVIDER"
						phaseIndex={29}
						autorouter={ROUTER}
					/>
					<autoroutingphase
						name="ROUTE_VSEN_B_CAP"
						phaseIndex={30}
						autorouter={ROUTER}
					/>
					<autoroutingphase
						name="ROUTE_VSEN_B_BUFFER"
						phaseIndex={31}
						autorouter={ROUTER}
					/>
					<autoroutingphase
						name="ROUTE_VSEN_B_HEADER"
						phaseIndex={32}
						autorouter={ROUTER}
					/>
					<autoroutingphase
			...
			<net name="PVDD" isPowerNet nominalTraceWidth="0.15mm" />
			<net name="ISEN_A_RAW" />
			<net name="ISEN_B_RAW" />
			<net name="ISEN_C_RAW" />
			...
			{false && (
				<>
					...
					/>
					<trace
						name="PVDD_02_PHASE_A_DECOUPLING"
						from=".Q1 > .DRAIN"
						to=".C4 > .pin1"
						width="0.8mm"
						routingPhaseIndex={3}
					...
					/>
					<trace
						name="PVDD_04_PHASE_B_DECOUPLING"
						from=".Q2 > .DRAIN"
						to=".C5 > .pin1"
						width="0.8mm"
						routingPhaseIndex={5}
					...
					/>
					<trace
						name="PVDD_06_PHASE_C_DECOUPLING"
						from=".Q3 > .DRAIN"
						to=".C6 > .pin1"
						width="0.8mm"
						routingPhaseIndex={7}
