  ...
  return (
    ...
    >
      ...
      >
        ...
        <resistor name="R7" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-9} schY={-5} pcbX={-2.35} pcbY={-3} pcbRotation={180} connections={{ pin1: N.DIO3_HDR, pin2: N.DIO3 }} />
        <resistor name="R8" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-3} schY={-5} pcbX={-2.45} pcbY={-9.2} connections={{ pin1: N.DIO2_HDR, pin2: N.DIO2 }} />
        ...
        <resistor name="R10" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={9} schY={-5} pcbX={-2.35} pcbY={-4.4} connections={{ pin1: N.DIO4_HDR, pin2: N.DIO4 }} />
        <resistor name="R11" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-9} schY={-6.9} pcbX={-2.45} pcbY={-6.1} connections={{ pin1: N.DIO5_HDR, pin2: N.DIO5 }} />
        <resistor name="R12" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-3} schY={-6.9} pcbX={-2.45} pcbY={-7.7} connections={{ pin1: N.DIO6_HDR, pin2: N.DIO6 }} />
        ...
        <resistor name="R18" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-9} schY={-8.8} pcbX={16.15} pcbY={-9.333} pcbRotation={180} connections={{ pin1: N.LP_RESET, pin2: N.NRESET }} />
        <resistor name="R19" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-3} schY={-8.8} pcbX={16.15} pcbY={-10.766} pcbRotation={180} connections={{ pin1: N.LEGACY_RESET, pin2: N.NRESET }} />
        ...
        <resistor name="R21" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={9} schY={-8.8} pcbX={16.15} pcbY={-12.199} pcbRotation={180} connections={{ pin1: N.LEGACY_RESET, pin2: N.DIO9 }} />
        <resistor name="R22" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={-3} schY={-10} pcbX={1.55} pcbY={-9.4} pcbRotation={180} connections={{ pin1: N.V33, pin2: N.DIO5 }} />
        <resistor name="R23" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schX={3} schY={-10} pcbX={1.55} pcbY={-10.65} pcbRotation={180} connections={{ pin1: N.V33, pin2: N.DIO6 }} />
      </group>
      ...
      >
        ...
        />
        <resistor name="R24" doNotPlace resistance="0ohm" footprint="0603" manufacturerPartNumber="DNM" schSectionName="OPTIONAL_FLASH" schX={1} schY={-2.5} pcbX={-2.3} pcbY={4.45} pcbRotation={180} connections={{ pin1: N.DIO14_HDR, pin2: N.DIO14 }} />
        <resistor name="R25" doNotPlace resistance="10kohm" footprint="0402" manufacturerPartNumber="DNM" schSectionName="OPTIONAL_FLASH" schX={4} schY={-2.5} pcbX={-5.85} pcbY={6.788} pcbRotation={270} connections={{ pin1: N.V33, pin2: N.DIO14 }} />
        <resistor name="R26" doNotPlace resistance="10kohm" footprint="0402" manufacturerPartNumber="DNM" schSectionName="OPTIONAL_FLASH" schX={7} schY={-2.5} pcbX={2.812} pcbY={-7.85} connections={{ pin1: N.V33, pin2: N.FLASH_WP }} />
        <resistor name="R27" doNotPlace resistance="10kohm" footprint="0402" manufacturerPartNumber="DNM" schSectionName="OPTIONAL_FLASH" schX={10} schY={-2.5} pcbX={7.75} pcbY={-6.862} pcbRotation={270} connections={{ pin1: N.V33, pin2: N.FLASH_HOLD }} />
        <capacitor
          name="C1"
          capacitance="100nF"
          footprint="0402"
      ...
      <group
        ...
        schTraceAutoLabelEnabled
      >
        <schematicsection name="CURRENT_MEASUREMENT" displayName="Removable Current-Measurement Link" sectionTitleFontSize="0.2mm" />
        <pinheader
          name="P2"
          pinCount={2}
          pitch="2.54mm"
          ...
          schSectionName="CURRENT_MEASUREMENT"
          schX={-7}
          schY={3}
          pcbX={-3.02}
          pcbY={11.4}
