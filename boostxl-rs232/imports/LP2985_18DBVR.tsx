...
export const LP2985_18DBVR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      supplierPartNumbers={{
  "jlcpcb": [
    "C95415"
      ...
      manufacturerPartNumber="LP2985-18DBVR"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-2.091880999999944,"y":1.8123540000000276},{"x":2.1165190000000393,"y":1.8123540000000276},{"x":2.1165190000000393,"y":-1.786446000000069},{"x":-2.091880999999944,"y":-1.786446000000069},{"x":-2.091880999999944,"y":1.8123540000000276}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C95415.obj",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C95415.step",
      ...
      schPinArrangement={{
            ...
            schPinStyle={{
              ...
              pin3: { marginBottom: "0.5mm" },
              pin5: { marginBottom: "1mm" },
            }}
      {...props}
    />
  )
