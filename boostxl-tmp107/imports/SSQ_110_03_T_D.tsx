...
export const SSQ_110_03_T_D = (props: ChipProps<typeof pinLabels>) => {
  ...
  "jlcpcb": [
    "C5379997"
      ...
      manufacturerPartNumber="SSQ-110-03-T-D"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-13.204000000000065,"y":2.7391999999999825},{"x":13.229399999999828,"y":2.7391999999999825},{"x":13.229399999999828,"y":-2.7391999999999825},{"x":-13.204000000000065,"y":-2.7391999999999825},{"x":-13.204000000000065,"y":2.7391999999999825}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C5379997.obj?uuid=c521c5e307514285b27bb4c944aa47df",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C5379997.step?uuid=c521c5e307514285b27bb4c944aa47df",
        pcbRotationOffset: 0,
