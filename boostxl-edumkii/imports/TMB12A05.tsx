...
export const TMB12A05 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      symbol={
        <symbol>
          <port name="pin1" pinNumber={1} aliases={["_POS"]} direction="left" schX={-3.81} schY={1.27} schStemLength={2.54} />
          <port name="pin2" pinNumber={2} aliases={["2"]} direction="left" schX={-3.81} schY={-1.27} schStemLength={2.54} />
          <schematicpath points={[{"x":3.556,"y":3.81},{"x":1.27,"y":1.778}]} strokeWidth={0.254} strokeColor="#880000" />
          <schematicpath points={[{"x":1.27,"y":-1.778},{"x":3.556,"y":-3.81}]} strokeWidth={0.254} strokeColor="#880000" />
          <schematicpath points={[{"x":3.556,"y":3.81},{"x":3.556,"y":-3.81}]} strokeWidth={0.254} strokeColor="#880000" />
  ...
  "jlcpcb": [
    "C96093"
      ...
      manufacturerPartNumber="TMB12A05"
      footprint={<footprint>
