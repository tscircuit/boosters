...
export const TMP117AIDRVR = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      pinAttributes={{
        pin2: { requiresGround: true },
        pin5: { requiresPower: true, requiresVoltage: "3.3V" },
  ...
  "jlcpcb": [
    "C699536"
      ...
      manufacturerPartNumber="TMP117AIDRVR"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-1.9517999999999347,"y":1.3167999999999438},{"x":1.3929999999999154,"y":1.3167999999999438},{"x":1.3929999999999154,"y":-1.3421999999999343},{"x":-1.9517999999999347,"y":-1.3421999999999343},{"x":-1.9517999999999347,"y":1.3167999999999438}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C699536.obj?uuid=c909123e4a7a4da5a0270979fee6c02c",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C699536.step?uuid=c909123e4a7a4da5a0270979fee6c02c",
        pcbRotationOffset: 0,
