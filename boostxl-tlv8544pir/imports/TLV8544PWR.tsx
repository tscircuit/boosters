...
export const TLV8544PWR = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			cadModel={{
				objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C2867322.obj?uuid=5377177da492449fa1a3111d646cac17",
				stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C2867322.step?uuid=5377177da492449fa1a3111d646cac17",
