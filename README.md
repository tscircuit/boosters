...
| [BOOSTXL-RS232 serial-interface BoosterPack](./boostxl-rs232/) | Dual-channel RS-232 transceiver, selectable 1.8 V/3.3 V logic supply, DB9 connector, signal-status LEDs, and configurable LaunchPad GPIO routing |
| [TIDA-00647 ADS1220 RTD BoosterPack](./tida-00647/) | 24-bit delta-sigma RTD acquisition, two-, three-, and four-wire sensor connections, precision reference network, SPI interface, and LaunchPad headers |
